...
module.exports = {
    ...
    requiredNodeVersion: '20.18.0'
};

// Check Node version
const nodeVersion = process.version;
if (nodeVersion !== 'v' + module.exports.requiredNodeVersion) {
    console.log(require('./lib/color')(`⚠️  Warning: Expected Node ${module.exports.requiredNodeVersion} but got ${nodeVersion}`, 'yellow'));
  }
